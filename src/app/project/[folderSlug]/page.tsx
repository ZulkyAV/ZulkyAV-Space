...
export default async function ProjectFolderPage({
  ...
  return (
    <div className="mx-auto max-w-6xl px-5 py-16 lg:px-8 lg:py-24">
      <Link href="/project" className="text-sm font-semibold text-primary-700">
        ← All projects
      </Link>
      <div className="mt-12 border-b border-neutral-200 pb-10">
      ...
      {projects.length ? (
        ...
        <p className="mt-10 text-neutral-500">No public projects here yet.</p>
      )}
    </div>
  );
}
